...
export default function Blog() {
  ...
  return (
    <div className="relative isolate pt-24 min-h-screen bg-obsidian">
      <SEO title="Calisthenics Blog: Guides & Training Tips" description="Calisthenics guides from the Cali Terrain coaching team in Secunderabad: beginner programs, pull-up plans, kids fitness, and what classes in Hyderabad cost." path="/blog" />
      <PageBackdrop />
      <PageHero
                ...
                <div className="p-6">
                  <div className="flex items-center justify-between mb-3">
                    ...
                    <div className="flex items-center gap-1 text-[#5C6B7C] text-xs">
                      ...
                      {new Date(post.created_at).toLocaleDateString("en-IN", { month: "short", year: "numeric", timeZone: "UTC" })}
                    </div>
                  </div>
