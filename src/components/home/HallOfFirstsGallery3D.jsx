...
import { FIRSTS as ENTRIES } from "@/data/firsts";
...
export default function HallOfFirstsGallery3D({ onBookTrial }) {
  ...
  return (
    <div
      ...
      onKeyDown={onKeyNav}
      className="group relative h-[80svh] min-h-[560px] w-full overflow-hidden rounded-lg border border-[#1E2A38] bg-[#05080D] outline-none focus-visible:ring-1 focus-visible:ring-[#2E8DFF]/60 sm:h-[88svh]"
    >
      {/* WebGL stage */}
