...
export const JOURNEY = {
  ...
  stages: [
    { n: "01", pose: "standing",   icon: Users,    title: "Assessment",  desc: "Find your starting point and understand where you are.",     img: "/journey/assessment.jpg" },
    { n: "02", pose: "pushup",     icon: Layers,   title: "Foundation",  desc: "Build solid movement foundations and master the basics.",    img: "/journey/foundation.jpg" },
    { n: "03", pose: "pullup",     icon: Rocket,   title: "Strength",    desc: "Increase your strength and unlock your physical potential.", img: "/journey/strength.jpg" },
    { n: "04", pose: "handstand",  icon: Target,   title: "Skills",      desc: "Learn real skills with precision, control and confidence.",  img: "/journey/skills.jpg" },
    { n: "05", pose: "ringdip",    icon: Activity, title: "Performance", desc: "Enhance performance, build endurance and move with power.",  img: "/journey/performance.jpg" },
    { n: "06", pose: "frontlever", icon: Trophy,   title: "Mastery",     desc: "Master your body. Move with freedom for life.", gold: true, img: "/journey/mastery.jpg" },
  ],
  pillars: [
...
export const SKILLS = {
  ...
  nodes: [
    ...
    { id: "pull-up",     name: "Pull-Up",     tier: "Strength",   difficulty: "Beginner",      time: "6–12 Weeks",  prereq: ["push-up"],          pos: { x: 37, y: 26 }, img: "/skills/pull-up-demo-poster.jpg?v=3", video: "/skills/pull-up-demo.mp4?v=3", poster: "/skills/pull-up-demo-poster.jpg?v=3", desc: "Unlock pulling strength. The single most important calisthenics milestone.",            insight: "Band-assisted reps and slow negatives get you to your first rep fastest." },
    { id: "l-sit",       name: "L-Sit",       tier: "Control",    difficulty: "Intermediate",  time: "2–4 Months",  prereq: ["push-up"],          pos: { x: 37, y: 74 }, img: "/skills/l-sit-demo-poster.jpg?v=1", video: "/skills/l-sit-demo.mp4?v=1", poster: "/skills/l-sit-demo-poster.jpg?v=1", desc: "Core compression and straight-arm strength. The gateway to every static hold.",         insight: "Start tucked, then one leg. Straight legs are the last 10% — earn the compression." },
    { id: "muscle-up",   name: "Muscle-Up",   tier: "Advanced",   difficulty: "Advanced",      time: "4–12 Months", prereq: ["pull-up"],          pos: { x: 68, y: 14 }, img: "/skills/muscle-up-demo-poster.jpg?v=2", video: "/skills/muscle-up-demo.mp4?v=2", poster: "/skills/muscle-up-demo-poster.jpg?v=2", desc: "Explosive pulling into a transition above the bar. The classic ultimate goal.",         insight: "Explosive high pull-ups + straight-bar dips unlock the transition over the bar." },
