...
import {
  Activity, BarChart3, ChevronsUp, Compass, Dumbbell, Flame, Footprints,
  Gauge, GraduationCap, HeartPulse, Layers, Move, Repeat,
  Rocket, Route, ShieldCheck, Sparkles, Target, TrendingUp, Trophy,
...
export const HERO = {
  ...
  coachPrompt: "Hi! I'd like to talk to a coach about starting calisthenics.",
  // Removes the "am I fit enough?" fear right under the CTAs.
  reassure: "No experience needed. Day one starts wherever you are.",
  // Phone hero: location pill above the headline + one-line reassurance under
  // the single CTA (the eyebrow, sub and second CTA are desktop-only there).
  location: "Bowenpally, Secunderabad",
  reassureShort: "Free trial · No experience needed",
  // Reuses the real headline stats from site.js — no invented figures.
  trust: STATS,
  // Tour built from the real walkthrough (scripts/build-hero-tour.py): every
  // zone in walking order — performance lane, freestyle mats + climbing rope,
  // functional rig, mobility runway, strength lab, conditioning corner, skill
  // arena bars/rings, parallel bars. The handheld footage can't be stabilized
  // cleanly, so each zone is its sharpest frame with a slow synthetic camera
  // move (push / drift) and dissolves — nothing shakes — in a seamless loop.
  // Portrait cut keeps each zone framed on phones. Caption timings live in
  // src/data/tourCues.js (generated by the same script).
  // `img*` doubles as the <video> poster / LCP image and the reduced-motion fallback.
  video: "/hero/tour-landscape.mp4?v=2",
  videoPortrait: "/hero/tour-portrait.mp4?v=2",
  img: "/hero/tour-landscape-poster.webp?v=2",
  imgPortrait: "/hero/tour-portrait-poster.webp?v=2",
};
...
export const JOURNEY = {
  ...
  stages: [
    { n: "01", pose: "standing",   icon: Users,    title: "Assessment",  desc: "Find your starting point and understand where you are.",     img: "/journey/assessment.webp" },
    { n: "02", pose: "pushup",     icon: Layers,   title: "Foundation",  desc: "Build solid movement foundations and master the basics.",    img: "/journey/foundation.webp" },
    { n: "03", pose: "pullup",     icon: Rocket,   title: "Strength",    desc: "Increase your strength and unlock your physical potential.", img: "/journey/strength.webp" },
    { n: "04", pose: "handstand",  icon: Target,   title: "Skills",      desc: "Learn real skills with precision, control and confidence.",  img: "/journey/skills.webp" },
    { n: "05", pose: "ringdip",    icon: Activity, title: "Performance", desc: "Enhance performance, build endurance and move with power.",  img: "/journey/performance.webp" },
    { n: "06", pose: "frontlever", icon: Trophy,   title: "Mastery",     desc: "Master your body. Move with freedom for life.", gold: true, img: "/journey/mastery.webp" },
  ],
  pillars: [
...
export const SKILLS = {
  ...
  nodes: [
    ...
    { id: "handstand",   name: "Handstand",   tier: "Skill",      difficulty: "Intermediate",  time: "4–8 Months",  prereq: ["l-sit"],            pos: { x: 68, y: 86 }, img: "/skills/handstand-demo-poster.webp", desc: "Balance, shoulder strength and body awareness — full inverted control.",                insight: "Wall time builds the shoulders; balance is the final layer once you're strong." },
    { id: "front-lever", name: "Front Lever", tier: "Mastery",    difficulty: "Advanced",      time: "8+ Months",   prereq: ["pull-up", "l-sit"], pos: { x: 68, y: 50 }, img: "/skills/front-lever-demo-poster.webp", desc: "Total-body tension and pulling mastery — an elite straight-arm hold.",                  insight: "Tuck → advanced tuck → straddle. Patience on the straight-arm scapular strength." },
  ],
};
...
// ── SECTION 7 · Training Disciplines ──────────────────────────────────────
...
// ── SECTION 8 · Coaches (outcome-first) ───────────────────────────────────
  ...
  items: [
    {
      ...
      media: { img: "/coaches/vidya-sagar.webp", label: "Coach portrait", hint: "Vidya Sagar", ratio: "3/4" },
    ...
    },
    {
      ...
      placeholder: false,
      outcomes: ["Calisthenics Skills", "Mobility & Range", "Women's Calisthenics Lead"],
      tag: "Skills & Mobility",
      media: { img: "/coaches/ananya.webp", label: "Coach portrait", hint: "Coach Ananya", ratio: "3/4" },
      memberQuote: { text: "Unlocked full shoulder mobility and my first freestanding handstand.", name: "Sneha R.", achieved: "First Handstand" },
    },
    {
      name: "Coach Siddharth",
      role: "Strength & Conditioning Coach",
      placeholder: false,
      outcomes: ["Strength Training", "Conditioning & HYROX", "Athletic Performance"],
      tag: "Strength & Performance",
      media: { img: "/coaches/siddharth.webp", label: "Coach portrait", hint: "Coach Siddharth", ratio: "3/4" },
      memberQuote: { text: "Cut 4 minutes off my 5K and built real functional strength.", name: "Vikram P.", achieved: "First 5K PR" },
    },
  ],
  footnote: "More than coaches. Partners in your journey.",
};

// ── SECTION 9 · Facility Experience ───────────────────────────────────────
...
export const FACILITY = {
  ...
  zones: [
    { name: "Mobility Zone",       icon: HeartPulse, desc: "Restore range and build the foundation your body needs.", media: { img: "/facility/cards/mobility-zone.webp?v=2", label: "Mobility zone photo", hint: "Turf + mobility tools", ratio: "4/3" } },
    { name: "Strength Lab",        icon: Dumbbell,   desc: "Free weights, machines and structured strength training.",  media: { img: "/facility/cards/strength-lab.webp?v=2", label: "Strength lab photo", hint: "Racks + free weights", ratio: "4/3" } },
    { name: "Performance Lane",    icon: Gauge,      desc: "Conditioning, sprints and athletic performance.",           media: { img: "/facility/cards/performance-lane.webp?v=2", label: "Performance lane photo", hint: "Turf running lane + sled", ratio: "4/3" } },
    { name: "Skill Arena",         icon: Sparkles,   desc: "Calisthenics, skills and advanced movement under the rig.", media: { img: "/facility/cards/skill-arena.webp?v=2", label: "Skill arena photo", hint: "Blue pull-up rig", ratio: "4/3" } },
    { name: "Freestyle Area",      icon: Waypoints,  desc: "Open space to flow, express and train creative movement.",  media: { img: "/facility/cards/freestyle-area.webp?v=2", label: "Freestyle area photo", hint: "Open bar area", ratio: "4/3" } },
    { name: "Monkey Bars",         icon: Footprints, desc: "Grip, swing and upper-body coordination.",                  media: { img: "/facility/cards/monkey-bars.webp?v=2", label: "Monkey bars photo", hint: "Overhead monkey bars", ratio: "4/3" } },
    { name: "Parallel Bars",       icon: Repeat,     desc: "Dips, holds and upper-body strength work.",                 media: { img: "/disciplines/calisthenics.webp", label: "Parallel bars photo", hint: "Parallettes / P-bars", ratio: "4/3" } },
    { name: "SkiErgs",             icon: Activity,   desc: "High-intensity conditioning for power and endurance.",      media: { img: "/disciplines/hybrid.webp", label: "SkiErg photo", hint: "Row of SkiErgs", ratio: "4/3" } },
  ...
  panorama: { img: "/facility/panorama.webp?v=3", label: "Wide Facility Panorama", hint: "Single wide shot showing all zones — used for the interactive hotspot map", ratio: "21/9" },
};
...
export const RESULTS = {
  ...
  sub: "We don't just create athletes. We build confidence, consistency and a community that keeps you coming back.",
  outcomes: [
    { value: 83, suffix: "%", label: "Achieved their first pull-up" },
    { value: 67, suffix: "%", label: "Unlocked a new skill within 6 months" },
    { value: 92, suffix: "%", label: "Would recommend Caliterrain" },
  ],
  reasons: [
    { icon: GraduationCap, title: "Expert Coaches",         desc: "Coached by experienced athletes who actually train." },
    { icon: Route,         title: "Structured Progression", desc: "A clear path so you always know your next step." },
...
// ── SECTION 12 · Testimonials (video-first) ───────────────────────────────
...
// ── Local SEO prose (rendered by VisitSection) ────────────────────────────
// A crawlable paragraph block naming the service, the locality and the
// neighbouring areas people actually search from. Every claim here is already
// true elsewhere on the site — this section just states it in prose.
export const LOCAL = {
  ...
  areas: [
    "Bowenpally", "Diamond Point", "Trimulgherry", "Marredpally", "Alwal",
    "Kompally", "Begumpet", "Paradise", "Karkhana", "Sainikpuri", "Secunderabad", "Hyderabad",
  ],
  links: [
    { to: "/programs", label: "See all 12 programs" },
    { to: "/pricing", label: "Fees & batch timings" },
    { to: "/contact", label: "Directions & contact" },
  ],
};
