...
export const HERO = {
  ...
  video: "/hero/tour-landscape.mp4?v=3",
  videoPortrait: "/hero/tour-portrait.mp4?v=3",
  img: "/hero/tour-landscape-poster.webp?v=3",
  imgPortrait: "/hero/tour-portrait-poster.webp?v=3",
};
...
export const FACILITY = {
  ...
  zones: [
    { name: "Mobility Zone",       icon: HeartPulse, desc: "Restore range and build the foundation your body needs.", media: { img: "/facility/cards/mobility-zone.webp?v=3", label: "Mobility zone photo", hint: "Turf + mobility tools", ratio: "4/3" } },
    { name: "Strength Lab",        icon: Dumbbell,   desc: "Free weights, machines and structured strength training.",  media: { img: "/facility/cards/strength-lab.webp?v=3", label: "Strength lab photo", hint: "Racks + free weights", ratio: "4/3" } },
    { name: "Performance Lane",    icon: Gauge,      desc: "Conditioning, sprints and athletic performance.",           media: { img: "/facility/cards/performance-lane.webp?v=3", label: "Performance lane photo", hint: "Turf running lane + sled", ratio: "4/3" } },
    { name: "Skill Arena",         icon: Sparkles,   desc: "Calisthenics, skills and advanced movement under the rig.", media: { img: "/facility/cards/skill-arena.webp?v=3", label: "Skill arena photo", hint: "Blue pull-up rig", ratio: "4/3" } },
    { name: "Freestyle Area",      icon: Waypoints,  desc: "Open space to flow, express and train creative movement.",  media: { img: "/facility/cards/freestyle-area.webp?v=3", label: "Freestyle area photo", hint: "Open bar area", ratio: "4/3" } },
    { name: "Monkey Bars",         icon: Footprints, desc: "Grip, swing and upper-body coordination.",                  media: { img: "/facility/cards/monkey-bars.webp?v=3", label: "Monkey bars photo", hint: "Overhead monkey bars", ratio: "4/3" } },
